                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom">
                          <#if imageList?size gt 0 >
                            <img jqimg="${imageList[0].url}" src="${imageList[0].url}"/></span>
                        </#if>
                    </div>
                    <!--下方的缩略图-->
                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specList as spec>
                            <dl>
                                ...
                                <dd><a href="javascript:;" ng-click="addItem('${spec.attributeName}','${item}')"
                                       class="{{isSelect('${spec.attributeName}','${item}')?'selected':''}}">${item}<span title="点击取消选择">&nbsp;</span>
                                    </a>
                                </dd>
                                </#list>
                            </dl>
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            ...
                            <ul class="goods-intro unstyled">
                                <#list customAttributeList as cst>
                                    <li>${cst.text}:${cst.value}</li>
                                </#list>
