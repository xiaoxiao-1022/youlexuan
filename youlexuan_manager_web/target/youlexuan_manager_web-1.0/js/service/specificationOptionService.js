...
app.service('specificationOptionService',function($http){
	...
	this.findPage=function(page,rows){
		return $http.get('../specificationOption/findPage.do?pageNum='+page+'&pageSize='+rows);
	}
	//查询实体
	...
	this.search=function(page,rows,searchEntity){
		return $http.post('../specificationOption/search.do?pageNum='+page+"&pageSize="+rows, searchEntity);
	}    	
});